...
% Load dataset
load('preprocessed_data/mergedData_Acc_TimeD_FreqD_MDay.mat'); % Replace with your dataset file
...
save('models/trained_feedforwardnet_for_TimeD_FreqD_MDay.mat', 'net', 'tr', ...
