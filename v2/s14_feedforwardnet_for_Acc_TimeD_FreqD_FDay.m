...
% Load dataset
load('preprocessed_data/mergedData_Acc_TimeD_FreqD_FDay.mat'); % Replace with your dataset file
...
% Columns to remove 
columnsToRemove = [110, 111, 112, 120, 121, 131]; 
...
save('models/trained_feedforwardnet_for_TimeD_FreqD_FDay.mat', 'net', 'tr', ...
